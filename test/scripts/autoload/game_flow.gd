...
@export var level_paths: Array[String] = [
	...
	"res://scenes/levels/Level3.tscn", # Your Level 3 scene
	"res://scenes/levels/Level4.tscn", # Your Level 4 scene
	"res://scenes/levels/Level5.tscn", # Your Level 5 scene
	"res://scenes/levels/Level6.tscn", # Your Level 6 scene
	"res://scenes/levels/Level7.tscn", # Your Level 7 scene
	"res://scenes/levels/Level8.tscn", # Your Level 8 scene
...
const GAME_COMPLETE_SCENE_PATH = "res://scenes/ui/GameComplete.tscn"
